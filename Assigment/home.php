    ...
    <div id="app">
            ...
            <div class="" style="background-color:var(--blue); font-size:1.2rem;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <a class="" href="{{ url('/') }}">
                            <div class="heading" style="background-color:var(--blue); font-size:2rem;">SportsIllustrated
                            </div>
                        </a>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                                ...
                                <h4 style="color: white;"><?php  session_start(); echo $_SESSION['name'] ; echo "  "; ?>
                                </h4>
                            </a>
        ...
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <h4 style="color: var(--blue) ;"><?php echo "Welcome to SportsHUB Mr. ";echo $_SESSION['name']; ?></h4>
            </div>
        </div>
    </div>
</body>
